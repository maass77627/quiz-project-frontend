...
const question8 = new Scenario("8", "If you hear a strange noise late at night", "you stay in bed and hide under your covers", "jump up and go investigate yourself", "call someone for help");
const question9 = new Scenario("9", "What type of person are you..", "morning", "night", "evening");
const question10 = new Scenario("10", "You are ordering pizza which would you most prefer", "mushrooms and spinach", "anchovies", "pepperoni and sausage");
